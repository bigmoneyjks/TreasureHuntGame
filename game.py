...
class MainGame:
    ...
    def create(self):
        ...
        FieldKit = Heals("Field Kit", 30, "You tighten the tourniquete around your wound so the blood stops bleeding")
        ...
        Vial = Heals("Goo Vial", 35, "You crush the vial and watch as the mysterious goop sinks into your skin")
        ...
        self.areaList = [] # Add Areas Here once done finding how to code them nicely
